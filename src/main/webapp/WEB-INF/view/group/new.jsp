	...
	<div class="container">
		...
		<div class="row">
			<div  class="col">
				...
				<div class="input-group mb-3">
					 <span class="input-group-text" id="basic-addon1">일주일에</span>
					<input type="number" name="color" class="form-control form-control-color" id="exampleColorInput" value="#000000" title="Choose your color" onchange="chageColor(this)">회 인증 
				</div>
			   <!--  <div class="input-group mb-3">
